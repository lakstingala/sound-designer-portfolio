...
const About = () => {
    ...
    return (
        <div className="relative w-full flex flex-col md:flex-row h-[840px] md:h-[600px] p-[12px] bg-[#1C221F] justify-center">
            <Image className="absolute bottom-[0] right-[0] shadow-2xl transition-shadow duration-300 ease-in-out md:h-[600px]" src={"/karolis.jpg"} width={1340} height={941} alt={"icon"} />

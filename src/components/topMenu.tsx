    ...
    return (
        <div className='sticky top-0 z-30'>
            <div className="w-full flex flex-row justify-between border border-red p-[12px] bg-[#DFDED0]">
                <h1 className={"text-[24px] text-[#1C221F] pl-[40px] md:pl-[70px] " + monserat.className}>Karolis Balčius</h1>
                <div className="flex flex-row space-x-[20px] pr-[40px] md:pr-[70px]">
